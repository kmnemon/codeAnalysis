...
public class ProjectDependencyTests {
    ...
    void findAllimportPaicTypesTests(){
        ...
        TypeInfo t1 = new ClassInfo("x1", "packA", con1);
        TypeInfo t2 = new ClassInfo("x2", "packB", con2);
        TypeInfo t3 = new ClassInfo("x3", "packC", con3);
        TypeInfo t4 = new ClassInfo("x4", "packD", con4);
        TypeInfo t5 = new ClassInfo("x5", "packE", con5);
        TypeInfo t6 = new ClassInfo("x6", "packF", con6);

        List<TypeInfo> ti1 = Arrays.asList(t1,t2);
        List<TypeInfo> ti2 = Arrays.asList(t3,t4);
        List<TypeInfo> ti3 = Arrays.asList(t5,t6);

        Map<String, List<TypeInfo>> modulesInProject = new HashMap<>();
        modulesInProject.put("x1", ti1);
        modulesInProject.put("x2", ti2);
        modulesInProject.put("x3", ti3);
